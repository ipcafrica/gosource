<template>
  <div class="card" @click="selectItem(card.value)" :class="{ clicked: selectedItem === card.value }">
    <div class="card-top">
      ...
      <svg class="try" v-if="isSelected" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
        fill="none">
        <path
