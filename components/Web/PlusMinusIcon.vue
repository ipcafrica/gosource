...
<div class="plus-minus-icon">
    <svg v-if="isOpen" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
...
<svg v-else xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
  ...
  <template>
    <div class="plus-symbol" :class="{'active': isOpen}">
  ...
  /* Vertical span of the Plus symbol */
  .vertical {
