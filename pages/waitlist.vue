<template>
  <div class="container">
    ...
    <div class="modal-container" v-if="!showModal" :class="{ 'slide-left': step > prevStep, 'slide-right': step < prevStep }" >
    ...
    <div class="congratulations" v-if="showModal" :class="{'slide-top': showModal }">
...
export default {
  ...
  methods: {
    ...
    async addToWaitlistCall(type) {
      const data = {
        fullName: type==='individual' ? this.fullName : '',
        email: this.email,
        businessName: type==='individual' ? '' : this.businessName,
      };
      try {
